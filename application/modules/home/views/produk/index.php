          ...
          <form action="" method="post" class="mt-1" id="kategori_form">
            <div class="form-group mb-3 pt-2">
              <div class="form-group">
                ...
                <select name="produk_kat_id" class="form-control custom" id="prod_kat_id"></select>
              </div>
              <div class="form-group">
                <label for="">Nama Produk</label>
                <input type="text" name="title" placeholder="Nama Produk" class="custom form-control" id="prod_title">
              </div>
            </div>
